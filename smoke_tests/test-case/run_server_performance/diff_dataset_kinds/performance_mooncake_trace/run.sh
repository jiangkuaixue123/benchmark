...
CONFIG_DATASET_NAME="mooncake_trace"
OUTPUT_DATASET_NAME="mooncake-trace"
...
ais_bench --models ${CASE_NAME} --datasets ${CASE_NAME} --work-dir ${CASE_OUTPUT_PATH} --mode perf 2>&1 | tee ${CUR_DIR}/tmplog.txt
if [ $? -eq 0 ]
then
